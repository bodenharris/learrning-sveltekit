...
<div class="min-h-screen {bgColor} p-8 {textColor}">
    ...
    <button class = "absolute right-2 top-25 rounded-full hover:outline-none hover:ring-2 ring-grey-500 transition">    
        <img src="profile.jpg" alt="" class="w-1/4 h-auto rounded-full">
    </button>
