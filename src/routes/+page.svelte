...
<div class="min-h-screen {bgColor} p-8 {textColor}">
    ...
    <button class = "absolute right-4 top-20 rounded-full hover:outline-none hover:ring-2 ring-grey-500 transition">    
        <img src="profile.jpg" alt="Profile Picture" class="w-1/4 h-auto rounded-full">
    </button>
