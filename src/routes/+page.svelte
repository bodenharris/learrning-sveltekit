...
<div class="min-h-screen {bgColor} p-8 {textColor}">
    ...
    <button class = "round hover:outline-none hover:ring-2 focus:ring-blue-500 transition">    
        <img src="profile.jpg" alt="Profile Picture" class="w-1/4 h-auto rounded-lg">
    </button>
